    ...
    <xsl:template match="seal">
        <seal>
            ...
            <xsl:attribute name="type">
                <xsl:value-of select="sealStatus" /> 
            </xsl:attribute>
            <ab>
                <xsl:apply-templates select="sealDescription" />
                <xsl:apply-templates select="sealReferenceWork[text()!='empty']" />
            </ab>
        </seal>
    </xsl:template>
    <xsl:template match="sealReferenceWork">
        <xsl:text>, </xsl:text>
        <ref>
